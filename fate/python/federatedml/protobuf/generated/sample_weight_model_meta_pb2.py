...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='sample-weight-model-meta.proto',
  package='com.webank.ai.fate.core.mlmodel.buffer',
  syntax='proto3',
  serialized_options=_b('B\032SampleWeightModelMetaProto'),
...
_SAMPLEWEIGHTMODELMETA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_weight_name', full_name='com.webank.ai.fate.core.mlmodel.buffer.SampleWeightModelMeta.sample_weight_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='normalize', full_name='com.webank.ai.fate.core.mlmodel.buffer.SampleWeightModelMeta.normalize', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='need_run', full_name='com.webank.ai.fate.core.mlmodel.buffer.SampleWeightModelMeta.need_run', index=2,
