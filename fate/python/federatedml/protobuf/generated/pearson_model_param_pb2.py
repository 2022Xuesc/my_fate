...
_PEARSONMODELPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='all_names', full_name='com.webank.ai.fate.core.mlmodel.buffer.PearsonModelParam.all_names', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anonymous_map', full_name='com.webank.ai.fate.core.mlmodel.buffer.PearsonModelParam.anonymous_map', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_name', full_name='com.webank.ai.fate.core.mlmodel.buffer.PearsonModelParam.model_name', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='local_vif', full_name='com.webank.ai.fate.core.mlmodel.buffer.PearsonModelParam.local_vif', index=10,
