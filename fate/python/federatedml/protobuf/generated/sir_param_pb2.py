...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='sir-param.proto',
  package='com.webank.ai.fate.common.mlmodel.buffer',
  syntax='proto3',
  serialized_options=_b('B\rSIRParamProto'),
...
_SECUREINFORMATIONRETRIEVALPARAM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='coverage', full_name='com.webank.ai.fate.common.mlmodel.buffer.SecureInformationRetrievalParam.coverage', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='block_num', full_name='com.webank.ai.fate.common.mlmodel.buffer.SecureInformationRetrievalParam.block_num', index=1,
