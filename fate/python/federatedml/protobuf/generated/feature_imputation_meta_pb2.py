...
_FEATUREIMPUTERMETA_COLSSTRATEGYENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureImputerMeta.ColsStrategyEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureImputerMeta.ColsStrategyEntry.value', index=1,
...
_FEATUREIMPUTATIONMETA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='imputer_meta', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureImputationMeta.imputer_meta', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='need_run', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureImputationMeta.need_run', index=1,
