...
_DATATRANSFORMIMPUTERMETA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='is_imputer', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformImputerMeta.is_imputer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='strategy', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformImputerMeta.strategy', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='missing_value', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformImputerMeta.missing_value', index=2,
...
_DATATRANSFORMOUTLIERMETA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='is_outlier', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformOutlierMeta.is_outlier', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='strategy', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformOutlierMeta.strategy', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outlier_value', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformOutlierMeta.outlier_value', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATATRANSFORMMETA_EXCLUSIVEDATATYPEENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformMeta.ExclusiveDataTypeEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='com.webank.ai.fate.core.mlmodel.buffer.DataTransformMeta.ExclusiveDataTypeEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
