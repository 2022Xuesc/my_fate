...
_MULTICLASSRESULT = _descriptor.Descriptor(
  name='MultiClassResult',
  full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult.results', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels', full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult.labels', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_results', full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult.host_results', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_party_ids', full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult.host_party_ids', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='has_host_result', full_name='com.webank.ai.fate.core.mlmodel.buffer.MultiClassResult.has_host_result', index=4,
...
_FEATUREBINNINGPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multi_class_result', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.multi_class_result', index=5,
...
_MULTICLASSRESULT.fields_by_name['results'].message_type = _FEATUREBINNINGRESULT
_MULTICLASSRESULT.fields_by_name['host_results'].message_type = _FEATUREBINNINGRESULT
...
_FEATUREBINNINGPARAM.fields_by_name['multi_class_result'].message_type = _MULTICLASSRESULT
...
DESCRIPTOR.message_types_by_name['MultiClassResult'] = _MULTICLASSRESULT
