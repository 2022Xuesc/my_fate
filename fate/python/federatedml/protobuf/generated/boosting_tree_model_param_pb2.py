...
_DECISIONTREEMODELPARAM_LEAFCOUNTENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='com.webank.ai.fate.core.mlmodel.buffer.DecisionTreeModelParam.LeafCountEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='com.webank.ai.fate.core.mlmodel.buffer.DecisionTreeModelParam.LeafCountEntry.value', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DECISIONTREEMODELPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='leaf_count', full_name='com.webank.ai.fate.core.mlmodel.buffer.DecisionTreeModelParam.leaf_count', index=3,
  ...
  nested_types=[_DECISIONTREEMODELPARAM_SPLITMASKDICTENTRY, _DECISIONTREEMODELPARAM_MISSINGDIRMASKDICTENTRY, _DECISIONTREEMODELPARAM_LEAFCOUNTENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
