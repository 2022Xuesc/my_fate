...
class GCNFitter(object):
    def __init__(
        ...
        # Todo: [WARN]
        # self.param.adj_file = "/home/klaus125/research/fate/my_practice/dataset/nuswide/data/guest/train/anno.json"
...
def _init_gcn_learner(param, device='cpu', adjList=None, label_prob_vec=None):
    ...
    in_channel = 300
    # 仅仅使用初始化权重，仍要进行学习
    model = aaai_fixed_connect_add_gcn(param.pretrained, adjList,
