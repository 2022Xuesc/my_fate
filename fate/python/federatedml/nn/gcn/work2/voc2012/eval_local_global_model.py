...
# Todo: 全局验证集的目录
valid_path = '/home/klaus125/research/fate/my_practice/dataset/voc_expanded/data/guest/val'
...
for task_name in jobid_map:
    ...
    for i in range(cnt):
        ...
        bn_data = np.load('bn_data_0.npy', allow_pickle=True)
        bn_tensors = []
        for arr in bn_data:
