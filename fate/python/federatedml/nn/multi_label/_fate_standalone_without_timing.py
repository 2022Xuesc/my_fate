...
for epoch in range(0, epochs):
    ...
    for train_step, (inputs, target) in enumerate(train_loader):
        ...
        before_batch_time = time.perf_counter()
        ...
        print(f"训练一个batch需要{end_batch_time - before_batch_time} s")

# 前向传播耗时：0.016667500138282776 s
# OMP算法执行耗时：1.4004576560109854 s
# 标签相关性损失（优化标签相关性）计算耗时：0.11752316355705261 s
# 标签损失反向传播耗时：0.5020901765674353 s
# 总损失计算耗时：0.1350837852805853 s
# 总损失反向传播耗时：0.5989101398736238 s
