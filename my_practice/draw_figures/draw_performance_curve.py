...
base_dir = '../experiment_res/AAAI/coco'
methods = ['fedavg', 'flag', 'fpsl', 'c_gcn', 'p_gcn', 'fixed_connect_prob_standard_gcn']

colors = ['g', 'b', 'r', 'y', 'purple', 'brown']
...
for i in range(len(methods)):
    method = methods[i]
    plt.plot(x_series, Series(AmAP_list[method][0:show_epochs]), colors[i])
plt.xlabel(x_axis)
