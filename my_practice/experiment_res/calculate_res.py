...
paths = ['sync_fpsl_resnet', 'sync_fpsl_fixed_ratio_drop','sync_fpsl_fixed_ratio_save',
         'sync_fpsl_lamp','sync_fpsl_dep_global','sync_fpsl_dep_drop_person_0.1','sync_fpsl_split_last']
for path in paths:
