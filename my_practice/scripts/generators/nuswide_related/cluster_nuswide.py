...
num_labels = 81
# train_dir需要修改
train_dir = "/home/klaus125/research/dataset/NUS-WIDE/images/train"
val_dir = "/home/klaus125/research/dataset/NUS-WIDE/images/val"
...
# coco数据集的标签数量是20
train_vec2names, train_vecs = get_label_vecs(train_image_id_path, num_labels=num_labels)
...
val_vec2names, val_vecs = get_label_vecs(val_image_id_path,num_labels=num_labels)
