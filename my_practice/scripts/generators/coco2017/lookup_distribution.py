...
train_image_id_path = '/data/projects/fate/my_practice/dataset/coco2017/train_image_id.json'
val_image_id_path = '/data/projects/fate/my_practice/dataset/coco2017/val_image_id.json'
